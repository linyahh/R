...
fire$time_1min=ymd_hms(fire$time_1min)
...
ggplot(fire,aes(x=time_1min)) +
    geom_bar(aes(y=post), stat = "identity",fill = "red",color = "black",linetype = "longdash") +
    geom_bar(aes(y=rt_post), stat = "identity",fill = "blue",color = "black") +
    theme(axis.text.x = element_text(angle = 90, hjust = 1))+
